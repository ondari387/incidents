...
?>
	...
	<head>
		...
		<title>Admin| Closed Incidents</title>
								...
								<div class="module-body table">
									...
									<table cellpadding="0" cellspacing="0" border="0" class="datatable-1 table table-bordered table-striped	 display">
										...
										<tbody>
											...
											$query = mysqli_query($bd, "select * from anonymous where status is 'in process'");
											...
											?>
												<tr>
													...
													<td> <a href="anonymous-details.php?cid=<?php echo htmlentities($row['incident_no']); ?>"> View Details</a>
													</td>
												</tr>
gi
											<?php  } ?>
